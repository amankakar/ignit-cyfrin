...
import {MockToken} from "./Invariant/utils/MockToken.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "forge-std/Test.sol";

contract ArbitratSetup is Test {
    ...
    address public igniteSmartContract =
        0xB71a820d80189073F69498010cb67bDDAe050633; //0xF1652dc03Ee76F7b22AFc7FF1cD539Cf20d545D5;
    address public joeRouterAddress =
        0x60aE616a2155Ee3d9A68541Ba4544862310933d4; //0xd7f655E3376cE2D7A2b08fF01Eb3B1023191A901;
    ...
    function setUp() public {
        ...
        StakingContract.ContractAddresses
            memory contractAddresses = StakingContract.ContractAddresses({
    ...
    function test_arbitrage() external {
        ...
        path[0] = address(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E);
        path[1] = ghost_joeRouter.WAVAX();
        path[2] = address(qiTokenAddress);
        ...
        //     stakeAmount
        // );
        // uint256 slippageFactor = 1000 - stakingInstance.slippage(); // Convert slippage percentage to factor
    ...
    function test_values() public {
        uint256 avaxPrice = 3774018500;
        uint256 qiPrice = 1411670;
        uint expectedQiAmount = (uint(avaxPrice) * 201e18) / uint(qiPrice); // qi amount
        console.log("Expected Amount", expectedQiAmount);
        console.log(
            "Expected Amount after converion",
            (expectedQiAmount * 9) / 10
        );
    }
